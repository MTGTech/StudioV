...
namespace NaturalPoint.NatNetLib
{
    ...
    internal static class NativeMethods
    {
        ...
        // Import function that do the remote trigger
		[DllImport( NatNetConstants.NatNetLibDllBaseName, EntryPoint = "?SendMessage1@NatNetClient@@QAEXPAD@Z", CallingConvention = NatNetConstants.NatNetLibCallingConvention)]
        public static extern NatNetError SendMessage(string szRequest);
